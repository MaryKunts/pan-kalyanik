export default function Footer() {
  return (
    <div className="flex justify-center items-center flex-col py-5 border-t-1 border-t-border">
      <div className="pb-3 hidden sm:flex flex-wrap gap-x-5 items-center justify-between text-lg text-muted-foreground w-7/12 lg:w-9/12  xl:w-6/12 lg:justify-between border-b-1 border-b-border">
        <div>Кальянная</div>
